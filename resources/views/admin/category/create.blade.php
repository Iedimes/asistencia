        ...
        <div class="col-lg-8 col-xl-7">
            <div class="card shadow-sm overflow-hidden" style="border: 1px solid #cbd5e1 !important; border-radius: 1rem !important; background: #ffffff;">
                ...
                <div class="card-header border-0 py-3 px-4 d-flex align-items-center gap-3" style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); color: white;">
                    <div class="d-flex align-items-center justify-content-center rounded-circle bg-success bg-opacity-25" style="width: 42px; height: 42px; background-color: rgba(22, 163, 74, 0.2);">
                        <i class="fa fa-plus text-success fs-5"></i>
                    </div>
                    <div>
                        <h4 class="mb-0 fw-bold text-white tracking-tight" style="font-size: 1.25rem;">NUEVA CATEGORÍA</h4>
                        <small class="text-white-50 font-weight-normal" style="font-size: 0.82rem;">Complete los datos para registrar una nueva categoría de atención técnica.</small>
                    </div>
                </div>
