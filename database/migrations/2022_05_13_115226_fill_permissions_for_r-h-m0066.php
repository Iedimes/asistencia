...
class FillPermissionsForRHM0066 extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRHM0066 constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.r-h-m0066',
            'admin.r-h-m0066.index',
            'admin.r-h-m0066.create',
            'admin.r-h-m0066.show',
            'admin.r-h-m0066.edit',
            'admin.r-h-m0066.delete',
            'admin.r-h-m0066.bulk-delete',
        ]);
