...
class FillPermissionsForRHM006 extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRHM006 constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.r-h-m006',
            'admin.r-h-m006.index',
            'admin.r-h-m006.create',
            'admin.r-h-m006.show',
            'admin.r-h-m006.edit',
            'admin.r-h-m006.delete',
            'admin.r-h-m006.bulk-delete',
        ]);
