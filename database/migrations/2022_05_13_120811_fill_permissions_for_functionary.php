...
class FillPermissionsForFunctionary extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFunctionary constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.functionary',
            'admin.functionary.index',
            'admin.functionary.create',
            'admin.functionary.show',
            'admin.functionary.edit',
            'admin.functionary.delete',
            'admin.functionary.bulk-delete',
        ]);
